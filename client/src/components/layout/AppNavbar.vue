<template>
  <!--
    ...
    └─ [DEFAULT] ele(header.app-navbar)
       ...
       │     │  - description:
       │     │      顶部搜索表单。
       │     │      用户输入关键词后提交，当前项目跳转到搜索页并携带 keyword 查询参数。
       │     │  - params:
    ...
    <header class="app-navbar">
      ...
      <div class="app-navbar__left">
        <!--
          ...
          - description:
              主导航菜单。
              当前项目保留搜索、详情和播放页入口，后续等你明确要求时再隐藏。
          - params:
      ...
      <div class="app-navbar__center">
        ...
        <form class="app-navbar__search" role="search" @submit.prevent="handleSearchSubmit">
          ...
          <!--
            ...
            - description:
                搜索提交按钮。
                使用图标按钮贴近 当前布局 顶部搜索视觉，并减少横向文字占位。
            - params: 无
            - events: 无
          -->
...
.app-navbar {
  ...
  /* 设置导航最小高度接近 当前布局 顶部栏，保证菜单和搜索控件有稳定点击面积。 */
  min-height: 64px;
