<template>
  <!--
    ...
    └─ [DEFAULT] ele(div.section-body)
       ...
       │
        ...
        │  - description: 统一展示热门电影标题、居中分页和“更多”入口。
  ...
  <section class="section-wrapper">
    ...
    <!--
      ...
      - type: 自定义组件，相对位置: ./HomeSectionHeader.vue。
      - description: 统一承载热门电影标题、居中分页和更多入口。
      - params: -- title/pagination/paging：当前热门电影标题和分页事实；-- aria-label：分页辅助名称。
