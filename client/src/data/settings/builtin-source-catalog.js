...
export const BUILTIN_SOURCE_CATALOG_REVISION = 26;

// 类型: string；作用: 当前内置目录面向发布记录和诊断的语义版本，不承担数据库结构迁移职责。
export const BUILTIN_SOURCE_CATALOG_VERSION = '2.40.0';

// 类型: string。
// 作用: 冻结 revision=26 对应的 Package 完整性与 Definition 发布事实；真实目录再次变化时必须重新计算指纹。
export const BUILTIN_SOURCE_CATALOG_FINGERPRINT = '0f27ee3a1ce78fee5b9ddfe0bc965a520e939e73831235d1df6c762d907a9f0c';

// 类型: string。
// 作用: 记录当前两条内置脚本作为产品系统源发布的统一 ISO 时间，不从浏览器启动时间制造漂移。
export const BUILTIN_SOURCE_CATALOG_RELEASED_AT = '2026-08-26T03:20:28.719Z';
...
export const BUILTIN_SOURCE_CATALOG_PREVIOUS_RELEASE = Object.freeze({
  ...
  revision: 25,
  version: '2.39.0',
  fingerprint: '4d957b62239804b6ceced75b155ef9a5cd6b48b0ba9919f00861479cb923c026'
});
