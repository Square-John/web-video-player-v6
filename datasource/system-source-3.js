...
// 类型: object。
// 作用: 静态声明系统数据源3的 ABI、身份、显示信息、页面能力和允许网络主机。
export const sourceManifest = Object.freeze({
  ...
  version: '2.0.1',
  providerKey: 'source.system.3.provider',
  capabilities: {
    home: true,
    movie: true,
    tv: true,
  ...
  settingsSchema: [],
  networkHosts: ['system-source-3.invalid']
});
...
const DEMO_CONTENT = Object.freeze({
  id: 'system-source-3-movie-001',
  type: 'movie',
  title: '演示影片三',
  originalTitle: 'System Demo Movie Three',
  aliases: [],
  poster: '',
  cover: '',
...
function createContentItem(sourceId) {
  ...
  return {
    ...
    episodes: [{
      id: 'system-source-3-movie-001-main',
      episodeNumber: 1,
      title: '正片',
      label: '正片',
      duration: '90分钟',
    ...
    playback: {
      defaultSourceId: 'system-source-3-line-1',
      sources: [{
        id: 'system-source-3-line-1',
        name: '演示线路三',
        type: 'mp4',
        url: '',
        quality: 'HD',
        available: false,
        episodeId: 'system-source-3-movie-001-main'
      }],
      headers: {
        referer: '',
        userAgent: ''
