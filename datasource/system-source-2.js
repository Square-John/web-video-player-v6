...
// 类型: object。
// 作用: 静态声明系统数据源2的 ABI、身份、显示信息、页面能力和允许网络主机。
export const sourceManifest = Object.freeze({
  ...
  version: '2.0.1',
  providerKey: 'source.system.2.provider',
  capabilities: {
    home: true,
    movie: true,
    tv: true,
  ...
  settingsSchema: [],
  networkHosts: ['system-source-2.invalid']
});
...
const DEMO_CONTENT = Object.freeze({
  id: 'system-source-2-movie-001',
  type: 'movie',
  title: '演示影片二',
  originalTitle: 'System Demo Movie Two',
  aliases: [],
  poster: '',
  cover: '',
...
function createContentItem(sourceId) {
  ...
  return {
    ...
    episodes: [{
      id: 'system-source-2-movie-001-main',
      episodeNumber: 1,
      title: '正片',
      label: '正片',
      duration: '90分钟',
    ...
    playback: {
      defaultSourceId: 'system-source-2-line-1',
      sources: [{
        id: 'system-source-2-line-1',
        name: '演示线路二',
        type: 'mp4',
        url: '',
        quality: 'HD',
        available: false,
        episodeId: 'system-source-2-movie-001-main'
      }],
      headers: {
        referer: '',
        userAgent: ''
